''' Each ListNode holds a reference to its previous 
node as well as its next node in the List. '''
...
class DoublyLinkedList:
    ...
    # Wraps given value in a ListNode and inserts it as the new head of the list.
    ...
    # Wraps given value in a ListNode and inserts it as the new tail of the list.
    ...
    # and inserts it as the new head node of the List.
    ...
    # Removes the input node from its current spot in the list
    # and inserts it as the new tail node of the List.
    ...
    def get_max(self):
        # loop through all nodes looking for the biggest value
        if not self.head:
            return None
